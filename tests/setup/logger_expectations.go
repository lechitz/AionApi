...
// It registers multiple arities to tolerate 0, 1, 2, 3, or 4 KV pairs commonly used in tests.
func ExpectLoggerDefaultBehavior(logger *mocks.MockContextLogger) {
	...
	logger.EXPECT().
		WarnwCtx(gomock.Any(), gomock.Any(), gomock.Any(), gomock.Any(), gomock.Any(), gomock.Any(), gomock.Any(), gomock.Any(), gomock.Any(), gomock.Any()).
		AnyTimes()
	...
	logger.EXPECT().DebugwCtx(gomock.Any(), gomock.Any(), gomock.Any(), gomock.Any(), gomock.Any(), gomock.Any(), gomock.Any(), gomock.Any()).AnyTimes()
	logger.EXPECT().
		DebugwCtx(gomock.Any(), gomock.Any(), gomock.Any(), gomock.Any(), gomock.Any(), gomock.Any(), gomock.Any(), gomock.Any(), gomock.Any(), gomock.Any()).
		AnyTimes()
}
