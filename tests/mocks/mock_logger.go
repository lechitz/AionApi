...
// Source: internal/core/ports/output/logger_output.go
//
// Generated by this command:
//
//	mockgen -source=internal/core/ports/output/logger_output.go -destination=tests/mocks/mock_logger.go -package=mocks -mock_names=ContextLogger=MockLogger
//
...
// MockLogger is a mock of ContextLogger interface.
...
func (m *MockLogger) ErrorwCtx(ctx context.Context, msg string, keysAndValues ...any) {
	m.ctrl.T.Helper()
	varargs := []any{ctx, msg}
	for _, a := range keysAndValues {
		varargs = append(varargs, a)
...
func (mr *MockLoggerMockRecorder) ErrorwCtx(ctx, msg any, keysAndValues ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]any{ctx, msg}, keysAndValues...)
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ErrorwCtx", reflect.TypeOf((*MockLogger)(nil).ErrorwCtx), varargs...)
}
...
func (m *MockLogger) InfowCtx(ctx context.Context, msg string, keysAndValues ...any) {
	m.ctrl.T.Helper()
	varargs := []any{ctx, msg}
	for _, a := range keysAndValues {
		varargs = append(varargs, a)
...
func (mr *MockLoggerMockRecorder) InfowCtx(ctx, msg any, keysAndValues ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]any{ctx, msg}, keysAndValues...)
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "InfowCtx", reflect.TypeOf((*MockLogger)(nil).InfowCtx), varargs...)
}
