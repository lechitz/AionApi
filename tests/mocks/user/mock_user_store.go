...
//
//	mockgen -source=internal/core/ports/output/db/user.go -destination=tests/mocks/user/mock_user_store.go -package=usermocks -mock_names=UserStore=MockUserStore
//
