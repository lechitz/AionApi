...
//
//	mockgen -source=internal/core/ports/output/token_output.go -destination=tests/mocks/token/mock_token_store.go -package=tokenmocks -mock_names=Store=MockTokenStore
//
