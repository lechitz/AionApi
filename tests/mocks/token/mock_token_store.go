...
//
//	mockgen -source=internal/core/ports/output/cache/token.go -destination=tests/mocks/token/mock_token_store.go -package=tokenmocks -mock_names=Store=MockTokenStore
//
