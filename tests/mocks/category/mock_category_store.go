...
//
//	mockgen -source=internal/core/ports/output/db/category.go -destination=tests/mocks/category/mock_category_store.go -package=categorymocks -mock_names=CategoryStore=MockCategoryStore
//
