...
// MockSecurityStore is a mock of SecurityStore interface.
...
func (mr *MockSecurityStoreMockRecorder) HashPassword(plain interface{}) *gomock.Call {
...
func (mr *MockSecurityStoreMockRecorder) ValidatePassword(hashed, plain interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
