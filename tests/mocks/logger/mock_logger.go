...
//
//	mockgen -source=internal/core/ports/output/logger_output.go -destination=tests/mocks/logger/mock_logger.go -package=loggermocks -mock_names=Logger=MockLogger
//
