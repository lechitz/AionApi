...
func (m *MockUserCreator) CreateUser(ctx context.Context, user domain.User) (domain.User, error) {
	m.ctrl.T.Helper()
...
func (m *MockUserRetriever) GetAllUsers(ctx context.Context) ([]domain.User, error) {
	m.ctrl.T.Helper()
...
func (m *MockUserRetriever) GetUserByEmail(ctx context.Context, email string) (domain.User, error) {
	m.ctrl.T.Helper()
...
func (m *MockUserRetriever) GetUserByID(ctx context.Context, ID uint64) (domain.User, error) {
	m.ctrl.T.Helper()
...
func (m *MockUserRetriever) GetUserByUsername(ctx context.Context, username string) (domain.User, error) {
	m.ctrl.T.Helper()
...
func (m *MockUserUpdater) UpdateUser(ctx context.Context, userID uint64, fields map[string]any) (domain.User, error) {
	m.ctrl.T.Helper()
...
// GetAllUsers mocks base method.
func (m *MockUserStore) GetAllUsers(ctx context.Context) ([]domain.User, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetAllUsers", ctx)
	ret0, _ := ret[0].([]domain.User)
	ret1, _ := ret[1].(error)
...
// GetUserByID mocks base method.
func (m *MockUserStore) GetUserByID(ctx context.Context, ID uint64) (domain.User, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetUserByID", ctx, ID)
	ret0, _ := ret[0].(domain.User)
	ret1, _ := ret[1].(error)
...
// UpdateUser mocks base method.
func (m *MockUserStore) UpdateUser(ctx context.Context, userID uint64, fields map[string]any) (domain.User, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "UpdateUser", ctx, userID, fields)
	ret0, _ := ret[0].(domain.User)
	ret1, _ := ret[1].(error)
