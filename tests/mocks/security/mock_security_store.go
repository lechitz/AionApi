...
//
//	mockgen -source=internal/core/ports/output/security/hasher.go -destination=tests/mocks/security/mock_security_store.go -package=securitymocks -mock_names=Store=MockSecurityStore
//
