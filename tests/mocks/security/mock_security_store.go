...
//
//	mockgen -source=internal/core/ports/output/hasher_output.go -destination=tests/mocks/security/mock_security_store.go -package=securitymocks -mock_names=Store=MockSecurityStore
//
