...
//
//	mockgen -source=internal/core/ports/output/category_output.go -destination=tests/mocks/mock_category_store.go -package=mocks -mock_names=CategoryStore=MockCategoryStore
//
