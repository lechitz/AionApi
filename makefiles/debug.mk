...
debug-roles:
	...
	@docker exec postgres-dev psql -U aion -d aionapi -c "\d aion_api.roles" || echo "❌ Table does not exist"
	@echo ""
	@echo "2. Counting roles..."
	@docker exec postgres-dev psql -U aion -d aionapi -t -c "SELECT COUNT(*) FROM aion_api.roles;" || echo "❌ Query failed"
	@echo ""
	@echo "3. Listing roles..."
	@docker exec postgres-dev psql -U aion -d aionapi -c "SELECT role_id, name, is_active FROM aion_api.roles ORDER BY role_id;" || echo "❌ Query failed"
	@echo ""
