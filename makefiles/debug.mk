...
debug-roles:
	...
	@docker exec postgres-dev psql -U aion -d aion-api -c "\d aion_api.roles" || echo "❌ Table does not exist"
	@echo ""
	@echo "2. Counting roles..."
	@docker exec postgres-dev psql -U aion -d aion-api -t -c "SELECT COUNT(*) FROM aion_api.roles;" || echo "❌ Query failed"
	@echo ""
	@echo "3. Listing roles..."
	@docker exec postgres-dev psql -U aion -d aion-api -c "SELECT role_id, name, is_active FROM aion_api.roles ORDER BY role_id;" || echo "❌ Query failed"
	@echo ""
