...
graphql.queries:
	...
	@mkdir -p "$(QUERIES_DIR)/categories" "$(QUERIES_DIR)/tags" "$(QUERIES_DIR)/records" "$(QUERIES_DIR)/chat" "$(QUERIES_DIR)/user"
	@mkdir -p "$(MUTATIONS_DIR)/categories" "$(MUTATIONS_DIR)/tags" "$(MUTATIONS_DIR)/records"
