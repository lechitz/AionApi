...
SWAG_DIRS    ?= ./cmd/aion-api,./internal/admin/adapter/primary/http/handler,./internal/auth/adapter/primary/http/handler,./internal/chat/adapter/primary/http/handler,./internal/user/adapter/primary/http/handler
SWAG_MAIN    ?= main.go
SWAG_PKG     ?= docs
