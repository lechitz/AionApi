...
func (r *HttpRouter) AddHealthCheckRoutes(gh *handlers.Generic) func(portRouter.Router) {
...
func (r *HttpRouter) AddUserRoutes(uh *handlers.User) func(portRouter.Router) {
	return func(rt portRouter.Router) {
...
func (r *HttpRouter) AddAuthRoutes(ah *handlers.Auth) func(portRouter.Router) {
	return func(rt portRouter.Router) {
