...
func InitRouter(logger *zap.SugaredLogger, userService inputHttp.UserService, authService inputHttp.AuthService, tokenService tokenports.TokenService, contextPath string) (*Router, error) {
	if contextPath == "" {
