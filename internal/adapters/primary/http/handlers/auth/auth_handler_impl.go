// Package auth provides authentication handlers for login and logout functionalities.
package auth
...
// Handler provides authentication handlers for login and logout functionalities.
type Handler struct {
