...
func NewService(userRepository output.UserRepository, tokenStore output.TokenStore, tokenProvider output.TokenProvider, hasher output.Hasher, logger output.ContextLogger) *Service {
	return &Service{
