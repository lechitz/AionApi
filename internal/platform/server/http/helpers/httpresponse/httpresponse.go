...
func WriteError(w http.ResponseWriter, err error, message string, logger logger.ContextLogger, headers ...map[string]string) {
...
func WriteDecodeError(w http.ResponseWriter, err error, logger logger.ContextLogger, headers ...map[string]string) {
...
func WriteAuthError(w http.ResponseWriter, err error, logger logger.ContextLogger, headers ...map[string]string) {
