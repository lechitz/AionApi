...
const (
	// DefaultRouteHealth Default health-check route inside the API context (e.g., /aion-api/health)
	DefaultRouteHealth = "/health"

	// DefaultSwaggerMountPath Where Swagger UI+assets are mounted under the API context (e.g., /aion-api/swagger/*)
	DefaultSwaggerMountPath = "/swagger"

	// DefaultDocsAliasPath Convenience alias that redirects to {SwaggerMountPath}/index.html (e.g., /aion-api/docs)
