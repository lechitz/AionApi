...
help:
	...
	@echo "  - [Quick Start]"
	@echo ""
	@echo "     db-full                  →  🚀 ONE COMMAND: migrations + essential + test profile"
	...
	@echo "  - [Test Data]"
	@echo ""
	@echo "     seed-test                →  🧪 Complete test profile: user + categories + tags + 50 records"
	@echo "     seed-clean-test          →  Remove ONLY test profile (testuser), keeps admin"
