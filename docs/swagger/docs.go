...
const docTemplate = `{
            ...
            "put": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/github_com_lechitz_AionApi_internal_admin_adapter_primary_http_dto.UpdateUserRolesResponse"
                        }
                    },
                    "400": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/github_com_lechitz_AionApi_internal_admin_adapter_primary_http_dto.UpdateUserRolesRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/github_com_lechitz_AionApi_internal_auth_adapter_primary_http_dto.SessionResponse"
                        }
                    },
                    "401": {
                        "description": "Unauthorized",
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/github_com_lechitz_AionApi_internal_chat_adapter_primary_http_dto.ChatRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/github_com_lechitz_AionApi_internal_chat_adapter_primary_http_dto.ChatResponse"
                        }
                    },
                    "400": {
                        "description": "Invalid request payload or validation error",
    ...
    "definitions": {
        "github_com_lechitz_AionApi_internal_admin_adapter_primary_http_dto.UpdateUserRolesRequest": {
            "type": "object",
            "properties": {
                "roles": {
        ...
        "github_com_lechitz_AionApi_internal_admin_adapter_primary_http_dto.UpdateUserRolesResponse": {
            "type": "object",
            "properties": {
                "email": {
        ...
        "github_com_lechitz_AionApi_internal_auth_adapter_primary_http_dto.SessionResponse": {
            "type": "object",
            "properties": {
                "authenticated": {
        ...
        "github_com_lechitz_AionApi_internal_chat_adapter_primary_http_dto.ChatRequest": {
            "type": "object",
            "required": [
                "message"
            ],
        ...
        "github_com_lechitz_AionApi_internal_chat_adapter_primary_http_dto.ChatResponse": {
            "type": "object",
            "properties": {
                "response": {
                    "type": "string",
                ...
                "usage": {
                    "$ref": "#/definitions/github_com_lechitz_AionApi_internal_chat_adapter_primary_http_dto.TokenUsage"
                }
            }
        },
        "github_com_lechitz_AionApi_internal_chat_adapter_primary_http_dto.TokenUsage": {
            "type": "object",
            "properties": {
                "completion_tokens": {
                    "type": "integer",
...
var SwaggerInfo = &swag.Spec{ //nolint:gochecknoglobals // generated by swag: global spec is required for registration
	Version:          "0.1.0",
	Host:             "",
	BasePath:         "/api/v1",
...
func init() { //nolint:gochecknoinits // generated by swag: init is required to register spec
